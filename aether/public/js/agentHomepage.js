// filepath: c:\Users\haran\Documents\GitHub\FSDP\aether\public\js\agentHomepage.js
...
document.addEventListener('click', (e) => {
  ...
  if (target) {
    window.location.href = '/agentHomepage';
  }
});
document.addEventListener('click', (e) => {
  const target = e.target.closest && e.target.closest('.conversation');
  if (target) {
    window.location.href = '/agentConversation';
  }
});
document.addEventListener('click', (e) => {
